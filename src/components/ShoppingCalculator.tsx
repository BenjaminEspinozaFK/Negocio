...
import { X, ShoppingCart, Plus, Minus, Trash2, Calculator, AlertTriangle } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
          ...
          <div className="bg-slate-900 p-4 border-t border-slate-700">
            ...
            {cart.length > 0 && (
              <div className="bg-slate-700 rounded-lg p-4">
                <div className="mb-3">
                  <label className="block text-sm text-slate-300 mb-2">Pago del cliente:</label>
                ...
                {payment > 0 && (
                  <div className="pt-3 border-t border-slate-600">
                    {payment >= total ? (
                      <div className="flex justify-between items-center">
                        <span className="text-base font-semibold text-white">Vuelto:</span>
                      ...
                      <div className="text-center">
                        <p className="text-sm text-red-400">El pago es insuficiente</p>
          ...
          <AlertDialogContent className="bg-slate-800 border-slate-700">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-slate-300">
                Esta acción eliminará todos los productos del carrito y reiniciará el monto de pago.
